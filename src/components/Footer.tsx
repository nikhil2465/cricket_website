...
const Footer = () => {
  ...
  const footerLinks = [
    ...
    },
    {
      title: 'Programs',
      links: [
        { name: 'Junior Academy', href: '/programs/junior' },
        { name: 'Advanced Training', href: '/programs/advanced' },
        { name: 'One-on-One Coaching', href: '/programs/coaching' },
    ...
    },
    {
      title: 'Contact Us',
      links: [
        { name: '123 Cricket Ground Rd', href: '#' },
        { name: 'Mumbai, 400001', href: '#' },
        { name: 'Phone: +91 98765 43210', href: 'tel:+919876543210' },
        { name: 'Email: info@elitecricket.com', href: 'mailto:info@elitecricket.com' },
      ],
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="col-span-1 lg:col-span-1">
            <div className="flex items-center">
              <div className="h-10 w-10 rounded-full bg-yellow-400 flex items-center justify-center mr-3">
                <span className="text-lg font-bold text-gray-900">ECA</span>
              </div>
              <h3 className="text-xl font-bold">Elite Cricket Academy</h3>
            </div>
            <p className="mt-4 text-gray-400 text-sm">
              Providing world-class cricket coaching and training to nurture the next generation of cricket champions.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <p className="text-base text-gray-400 text-center">
            &copy; {currentYear} Elite Cricket Academy. All rights reserved.
          </p>
